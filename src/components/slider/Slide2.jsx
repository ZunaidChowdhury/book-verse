...
export default function GroundedHero({ isDarkMode }) {
    return (
        <section className={`relative w-full min-h-auto tablet:min-h-[calc(100vh-5rem)] overflow-hidden flex items-start tablet:items-center transition-colors duration-300 ${
            isDarkMode
